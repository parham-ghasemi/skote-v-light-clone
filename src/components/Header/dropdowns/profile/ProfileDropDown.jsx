...
export default function ProfileDropDown() {
  return(
    <div className="animate-fade-up animate-once animate-duration-200 bg-neutral-50 shadow-dropdowns absolute -left-10 top-[8vh] w-40 h-44 rounded-md py-3 justify-between flex flex-col">
